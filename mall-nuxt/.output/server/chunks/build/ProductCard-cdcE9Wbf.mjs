import { defineComponent, computed, resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, toDisplayString, renderSlot, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="product-card__price-row" data-v-1b9d6bc8><div class="product-card__price" data-v-1b9d6bc8><span class="product-card__price-current" data-v-1b9d6bc8>\xA5${ssrInterpolate(formatPrice(__props.product.price))}</span>`);
      if (hasDiscount.value) {
        _push(`<span class="product-card__price-original" data-v-1b9d6bc8> \xA5${ssrInterpolate(formatPrice(__props.product.original_price))}</span>`);
      } else {
        _push(`<!---->`);
      }
      if (hasDiscount.value) {
...
export { ProductCard as P, _sfc_main$1 as _ };
//# sourceMappingURL=ProductCard-cdcE9Wbf.mjs.map
