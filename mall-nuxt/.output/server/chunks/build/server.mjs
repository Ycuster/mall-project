import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, ref, defineComponent, h, getCurrentScope, reactive, effectScope, isRef, isReactive, toRaw, isVNode, createCommentVNode, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, createElementBlock, shallowRef, provide, cloneVNode, defineAsyncComponent, unref, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, toRef, withCtx, isReadonly, useSSRContext, isShallow } from 'vue';
import { l as klona, p as parseURL, e as encodePath, m as decodePath, f as createError$1, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, r as parse, v as getRequestHeader, d as destr, x as isEqual, y as sanitizeStatusCode, z as getContext, A as setCookie, B as getCookie, C as deleteCookie, $ as $fetch, D as defu, E as createHooks, F as executeAsync } from '../_/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { RouterView, useRoute as useRoute$1, START_LOCATION, createMemoryHistory, createRouter } from 'vue-router';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-H_Bk-h3Q.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BlkdFn8o.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-DvN8_R-3.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./orders-KPOCsYfs.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import('./profile-BfHVtxs6.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-Bb9gJhEh.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./products-Be7GRTfZ.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-CR1nT9nG.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./index-3piZJTLh.mjs')
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./users-CTcL-WU7.mjs')
  },
  {
    name: "admin-orders",
    path: "/admin/orders",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./orders-C4eQIbkA.mjs')
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import('./_id_-D6Khe-rO.mjs')
  },
  {
    name: "admin-products",
    path: "/admin/products",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./products-Ek2xxZLY.mjs')
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./dashboard-D4IvoGM7.mjs')
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: __nuxt_page_meta || {},
    component: () => import('./categories-DWuaktDM.mjs')
  }
];
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-a7zFH7-M.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-waIWeTfS.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CbV1WhHH.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-kJqoVr_o.mjs'));
...
export { _export_sfc as _, useRoute as a, useCookie as b, useRouter as c, useRuntimeConfig as d, entry_default as default, encodeRoutePath as e, nuxtLinkDefaults as f, defineStore as g, asyncDataDefaults as h, createError as i, __nuxt_component_1 as j, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
