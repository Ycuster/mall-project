...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const statCards = computed(() => [
      { label: "\u603B\u8425\u6536", value: "\xA5" + Number(stats.value.totalRevenue || 0).toLocaleString(), icon: "Coin", color: "#f59e0b", bg: "#fffbeb" },
                            ...
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_el_table_column, {
                                ...
                                default: withCtx(({ row }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`\xA5${ssrInterpolate(Number(row.price).toFixed(2))}`);
                                  } else {
                                    return [
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(_component_el_table_column, {
                                ...
                                default: withCtx(({ row }, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`\xA5${ssrInterpolate(Number(row.total_amount).toFixed(2))}`);
                                  } else {
                                    return [
                                      createTextVNode("\xA5" + toDisplayString(Number(row.total_amount).toFixed(2)), 1)
                                    ];
                                  }
                                }),
                                _: 1
...
//# sourceMappingURL=dashboard-D4IvoGM7.mjs.map
