import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, onScopeDispose, watch, nextTick, toRefs, computed, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, Suspense, mergeProps, isVNode, createCommentVNode, Fragment, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "D:/vuetest/mall-project/mall-nuxt/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/vuetest/mall-project/mall-nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/vuetest/mall-project/mall-nuxt/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "D:/vuetest/mall-project/mall-nuxt/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "D:/vuetest/mall-project/mall-nuxt/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "D:/vuetest/mall-project/mall-nuxt/node_modules/ufo/dist/index.mjs";
import { klona } from "D:/vuetest/mall-project/mall-nuxt/node_modules/klona/dist/index.mjs";
import axios from "axios";
import { parse } from "D:/vuetest/mall-project/mall-nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "D:/vuetest/mall-project/mall-nuxt/node_modules/destr/dist/index.mjs";
import { isEqual } from "D:/vuetest/mall-project/mall-nuxt/node_modules/ohash/dist/index.mjs";
...
const sensitiveMatcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (l > 1) {
      if (s[1] === "api") {
        r.push({ data: $1, params: { "_": p.slice(5) } });
      } else if (s[1] === "uploads") {
        r.push({ data: $1, params: { "_": p.slice(9) } });
      } else if (s[1] === "admin") {
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import("./_nuxt/cart-H_Bk-h3Q.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BlkdFn8o.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-DvN8_R-3.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/orders-KPOCsYfs.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-BfHVtxs6.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import("./_nuxt/checkout-Bb9gJhEh.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-Be7GRTfZ.js")
  },
  {
    name: "register",
    path: "/register",
    component: () => import("./_nuxt/register-CR1nT9nG.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/index-3piZJTLh.js")
  },
  {
    name: "admin-users",
    path: "/admin/users",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/users-CTcL-WU7.js")
  },
  {
    name: "admin-orders",
    path: "/admin/orders",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/orders-C4eQIbkA.js")
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import("./_nuxt/_id_-D6Khe-rO.js")
  },
  {
    name: "admin-products",
    path: "/admin/products",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/products-Ek2xxZLY.js")
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/dashboard-D4IvoGM7.js")
  },
  {
    name: "admin-categories",
    path: "/admin/categories",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/categories-DWuaktDM.js")
  }
];
...
const layouts = {
  admin: defineAsyncComponent(() => import("./_nuxt/admin-a7zFH7-M.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-waIWeTfS.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CbV1WhHH.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-kJqoVr_o.js"));
